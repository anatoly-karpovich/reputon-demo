...
- main:
  ...
  - button "Mobile":
    ...
    - text: Mobile
  - link "Halle review":
    - /url: https://improbable-antelope.info/
    - img "Halle_image"
  - link "Halle review":
    - /url: https://improbable-antelope.info/
    - text: Halle
  ...
  - img
  - img
  - text: Administratio omnis anser fugiat sint crepusculum. Arx vulgo ager. Stabilis theatrum vacuus statim. Caute dolorem uter. Vociferor tonsor uxor distinctio laborum comburo cena vitium colo. Crapula ciminatio delibero totam spoliatio enim.
  - img "review_image"
  - link "Vladimir review":
    - /url: https://plain-academics.name/
    - img "Vladimir_image"
  - link "Vladimir review":
    - /url: https://plain-academics.name/
    - text: Vladimir
  ...
  - img
  - img
  - text: Civitas denuncio tibi similique bis. Carcer acervus curto fugit bene. Subvenio adduco verbera apparatus vulgo ulterius antea. Quos caelum clamo ambitus suggero vitium tener quidem. Cohors verumtamen infit adipisci. Verbum vestigium uxor tunc adiuvo caterva auctus. Decet ver veniam civitas tredecim tabernus sustineo vomica bis vulnero. Tricesimus administratio minus somniculosus delego. Comburo avaritia tremo conspergo accendo libero subiungo creber adiuvo textor. Traho bellum vitiosus illum considero.
  - img "review_image"
...
- img
- img
- text: 5 Star Ratingby Halle 3 дня назад
- img
- text: Arbofor - Leefdaal Gardens bv 5.0
- img
- img
