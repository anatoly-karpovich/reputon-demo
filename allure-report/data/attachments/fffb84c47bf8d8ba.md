...
- main:
  ...
  - button "Mobile":
    - img
    - text: Mobile
  - link "Antoinette review":
    - /url: https://forceful-yin.net
    - img "Antoinette_image"
  - link "Antoinette review":
    - /url: https://forceful-yin.net
    - text: Antoinette
  - text: 3 дня назад
  ...
  - img
  - img
  - text: Barba stabilis animi succedo. Vomito deficio decumbo virgo creator. Dolores temptatio pecus atrocitas validus amor tergo aestas. Desipio carmen termes. Vomito ante arceo ambulo in ocer auditor tabesco trepide.
  - img "review_image"
  - link "Henry review":
    - /url: https://insistent-schnitzel.net
    - img "Henry_image"
  - link "Henry review":
    - /url: https://insistent-schnitzel.net
    - text: Henry
  ...
  - img
  - img
  - text: Decens peccatus stabilis pel quas caste. Adduco cumque tamquam coadunatio argumentum speculum. Tendo eveniet quaerat voro vitae bos eligendi quis absens. Thermae uredo viscus facere. Ademptio ab auctus antiquus tertius adeo carpo.
  - img "review_image"
...
- img
- img
- text: 5 Star Ratingby Antoinette 3 дня назад
```