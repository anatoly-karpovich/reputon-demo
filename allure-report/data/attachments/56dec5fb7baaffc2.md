...
- main:
  ...
  - button "Mobile":
    ...
    - text: Mobile
  - link "Alvera review":
    - /url: https://celebrated-passport.org
    - img "Alvera_image"
  - link "Alvera review":
    - /url: https://celebrated-passport.org
    - text: Alvera
  ...
  - img
  - img
  - text: Colligo amicitia vespillo terror usque terra vivo alii. Temporibus degusto tego arca ocer aeneus. Eius victus ocer nisi vinculum sursum suspendo vilitas copiose pel. Tyrannus sumo alias aequitas cogito taceo temperantia. Ara veritas temporibus supra. Tutis cribro cursus abstergo utpote auctor vinum laboriosam enim vestigium.
...
- img
- img
- text: 2 Star Ratingby Alvera 3 дня назад
- button "Open chat"
```